...
async function displayData() {
  ...
  // Три рази виводимо виводимо поточне значення генератора в консольconsole.log((await dataGenerator.next()).value);
...
let countdownGenerator = function* (start) {
  let count = start;
